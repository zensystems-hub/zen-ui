...
function UpDownTrafficChart(_a) {
    ...
    return (React__default.createElement(ReactEcharts, { theme: theme, showLoading: loading, style: { height: height }, option: tslib_es6.__assign(tslib_es6.__assign({ dataset: dataset }, upDownStackAreaChartOptions), options) }));
}
