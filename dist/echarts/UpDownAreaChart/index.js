...
function UpDownAreaChart(_a) {
    var loading = _a.loading, _b = _a.options, options = _b === void 0 ? {} : _b, height = _a.height, theme = _a.theme, dataset = _a.dataset;
    return (React__default.createElement(ReactEcharts, { theme: theme, showLoading: loading, style: { height: height }, option: tslib_es6.__assign(tslib_es6.__assign({ dataset: dataset }, upDownAreaChartOptions), options) }));
}
...
exports.default = UpDownAreaChart;
