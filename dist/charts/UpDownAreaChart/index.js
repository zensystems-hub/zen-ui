...
function UpDownAreaChart(_a) {
    ...
    return (React__default.createElement(ReactEcharts, tslib_es6.__assign({ style: { height: height }, option: tslib_es6.__assign(tslib_es6.__assign({ dataset: dataset }, upDownAreaChartOptions), option) }, other)));
}
